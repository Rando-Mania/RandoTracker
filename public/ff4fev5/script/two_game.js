...
function staffDummyText() {
    Tracker.updateLayoutMultiple([
        {property: 'commentator-name-1', value: 'CommanderLeonhart'},
        {property: 'commentator-pronoun-1', value: '(They/Them)'},
        {property: 'commentator-name-2', value: 'RowdyRoddySniper'},
        {property: 'commentator-pronoun-2', value: '(Ze/Hir)'},
        {property: 'restreamers', value: 'BeautyInDiscovery'},
        {property: 'trackers', value: 'FirebirdLover'}
    ]);
}
// tracker.init(){
